...
class __TwigTemplate_27d5a26c07c6802b8382b75660d55756 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["type"] => $context["messages"]) {
            ...
            echo "  ";
            // line 45
            $context["classes"] = [0 => "alert", 1 => "alert-dismissible", 2 => "d-flex align-items-center", 3 => "fade", 4 => "show", 5 => "col-12", 6 => (((            // line 52
$context["type"] == "status")) ? ("alert-success") : ("")), 7 => (((            // line 53
$context["type"] == "warning")) ? ("alert-warning") : ("")), 8 => (((            // line 54
$context["type"] == "error")) ? ("alert-danger") : ("")), 9 => (((            // line 55
$context["type"] == "info")) ? ("alert-info") : (""))];
            ...
            echo "\" ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["attributes"] ?? null), 66, $this->source), "role", "aria-label"), "addClass", [0 => ($context["classes"] ?? null)], "method", false, false, true, 66), "setAttribute", [0 => "data-drupal-selector", 1 => "messages"], "method", false, false, true, 66), "setAttribute", [0 => "role", 1 => (($__internal_compile_1 = ($context["role"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1[$context["type"]] ?? null) : null)], "method", false, false, true, 66), 66, $this->source), "html", null, true);
            echo ">
    ";
            // line 67
...
", "themes/contrib/bootstrap_barrio/templates/misc/status-messages--alerts.html.twig", "/var/www/html/web/themes/contrib/bootstrap_barrio/templates/misc/status-messages--alerts.html.twig");
    }
